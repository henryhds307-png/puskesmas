...
<link rel='stylesheet' href='https://cdn.datatables.net/1.10.22/css/jquery.dataTables.min.css'/>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="section-title">
							<h2>JADWAL PELAYANAN PASIEN</h2>
							<img src="img/section-img.png" alt="#">
							<p>Jadwal Pelayanan Pasien Disesuaikan Dengan Jadwal Operasional dan Waktu Pendafataran Pasien</p>
						</div>
					</div>
				</div>
				<div class="row">
    ...
    <tbody>
                <tr>
                    <td><?php echo $no++; ?></td>
                            <td><?php echo $row_jadwal['id_pasien']; ?>-<?php echo $row_jadwal['nm_pasien']; ?></td>
                            <td><?php echo $row_jadwal['jenkel']; ?></td>
                            <td><?php echo $row_jadwal['tmpt_lahir']; ?>, <?php echo $row_jadwal['tgl_lahir']; ?></td>
                            <td><?php echo $row_jadwal['alamat']; ?></td>
                            <td><?php echo $row_jadwal['nm_poli']; ?></td>
                            <td><?php echo $row_jadwal['nm_dokter']; ?></td>
                            <td><?php echo $row_jadwal['tgl_berobat']; ?></td>
                            <td><?php echo $row_jadwal['keluhan']; ?></td>
                            <td><?php echo $row_jadwal['no_hp']; ?></td>
                        	<td>
								<?php $ps= $row_jadwal['nm_dokter'];
								if ($ps == '') {
								echo '<font color="red"><b>Dokter Belum Ditentukan</font>'; 
								}
								else {
								echo '<b><font color="blue">Datang Sesuai Jadwal Penanganan</font>';
								# code…
								} ?>
    						 </td>
                          </tr>
