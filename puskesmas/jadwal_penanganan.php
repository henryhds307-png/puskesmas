...
?>
        ...
        <tr>
            ...
            <td><?php echo htmlspecialchars($row_jadwal['no_hp']); ?></td>
			<td>
			<?php $ps= $row_jadwal['nm_dokter'];
			if ($ps == '') {
			echo '<font color="red"><b>Dokter Belum Ditentukan</font>'; 
					}
				elseif (empty($row_jadwal['nm_poli'])){echo "<font color='red'><b>Belum Ada Poli</b></font>";}	
				else {
...
echo "Jumlah data: " . mysqli_num_rows($jadwal);
?>
