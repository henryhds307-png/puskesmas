...
$query_jadwal = "
SELECT poli.kd_poli, poli.nm_poli, COUNT(pasien.id_pasien) AS total_pasien
FROM poli
LEFT JOIN pasien ON pasien.kd_poli = poli.kd_poli
GROUP BY poli.kd_poli, poli.nm_poli
ORDER BY poli.kd_poli DESC    

";

// Hitung total data untuk pagination
$totalRowsResult = mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM poli");
if (!$totalRowsResult) {
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="section-title">
							<h2>DAFTAR PELAYANAN POLIKLINIK</h2>
							<img src="img/section-img.png" alt="#">
							<p>Daftar Pelayanan Poliklinik yang disediakan oleh UPTD Puskesmas Perumnas Batu 6</p>
						</div>
					</div>
				</div>
				<div class="row">
...
<table id="example" class="display" style="width:100%">
            ...
            <?php $no=1; while ($row_jadwal = mysqli_fetch_assoc($jadwal)) { ?>
    <tbody>
                <tr>
                    <td><?php echo $no++; ?></td>
                            <td><?php echo $row_jadwal['kd_poli']; ?></td>
                            <td><?php echo $row_jadwal['nm_poli']; ?></td>
							<td><?php echo $row_jadwal['total_pasien']; ?></td>
                          </tr>
